<template>
    <div class="customer">
        <div class="info-page-banner">
            ...
            <div class="info-banner-header">Terms & Conditions policy</div>
